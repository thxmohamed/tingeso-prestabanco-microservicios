package com.tutorial.checkrulesservice.service;

import com.tutorial.checkrulesservice.entity.CheckRulesEntity;
import com.tutorial.checkrulesservice.model.CreditModel;
import com.tutorial.checkrulesservice.model.UserModel;
import com.tutorial.checkrulesservice.repository.CheckRulesRepository;
...
public class CheckRulesService {
    ...
    public void checkRelationQuotaIncome(Long checkid) {
        ...
        if (checkRulesOpt.isPresent()) {
            ...
            Optional<CreditModel> creditOpt = Optional.ofNullable(restTemplate.getForObject("http://ms-credit-service/find/" + checkRules.getCreditID(), CreditModel.class));
